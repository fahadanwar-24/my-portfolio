...
$search_banner = bizkorp_option('search_banner', true);
$search_layout = bizkorp_option('search_layout', 'right-sidebar');
                ...
                <div class="col-lg-12 my-auto">
                    <div class="banner-content text-<?php echo esc_attr( $banner_text_align ); ?>">
                        <h2 class="banner-title"><?php
							...
							printf( esc_html__( 'Search Results for: %s', 'bizkorp' ), '<span>' . get_search_query() . '</span>' );
							?>
                        </h2>
