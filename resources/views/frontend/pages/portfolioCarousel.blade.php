...
@section('title', 'Portfolio Carousel')
@section('content')
    <!-- header area -->
    ...
    <!-- header area end -->
        ...
        <section class="portfolio-carousel-page">
            <div class="container">
                <div class="swiper-container portfolio-carousel-page__carousel carousel-page-dot-style">
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-page__single">
                                ...
                                <div class="portfolio-page__content">
                                    <div class="portfolio-page__title-box">
                                        <p class="portfolio-page__sub-title">Solution</p>
                                        <h3 class="portfolio-page__title"><a href="{{ route('portfolioDetails') }}">Idea
                                                Generate</a>
                                        </h3>
                                    </div>
                                    <div class="portfolio-page__arrow">
