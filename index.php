...
get_header();
$blog_layout = bizkorp_option('blog_layout', 'right-sidebar');
$enable_banner = bizkorp_option('blog_banner', true);
$enable_blog_banner_title = bizkorp_option( 'enable_blog_banner_title', true );
$banner_title = bizkorp_option('blog_title');
$blog_breadcrumb = bizkorp_option( 'enable_blog_banner_breadcrumb', true );
